...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { category: @donation.category, organization: @donation.organization, quantity: @donation.quantity }
    end
  ...
  test "should update donation" do
    patch :update, id: @donation, donation: { category: @donation.category, organization: @donation.organization, quantity: @donation.quantity }
    assert_redirected_to donation_path(assigns(:donation))
  end
